...
@Named @ViewScoped
public class DistribuerBCCSSotraController extends AbstractBonCommandeCarteSotraListe implements Serializable  {
	...
	protected void initialisation() {
		...
		showValide=true;
		showDateDistributionSotra=true;
	}
	
	@Override
	protected String natureOperationCode() {
		return Code.NATURE_OPERATION_DISTRIBUTION_CCS_SOTRA;
	}
