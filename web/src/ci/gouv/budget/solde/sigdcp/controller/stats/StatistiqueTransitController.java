...
@Named @ViewScoped
public class StatistiqueTransitController extends AbstractStatistiqueNatureDeplacementController implements Serializable {
	...
	protected void initialisation() {
		...
		title="Statistique : Bilan des transits";	
		natureDeplacements = new ArrayList<>(natureDeplacementService.findByCategorieId(Code.CATEGORIE_DEPLACEMENT_TRANSIT));
