...
public class BulletinLiquidationController implements Serializable {
	...
	private void populateRandomTypePieces(List<TypePieceProduite> list) {  
        ...
        typepieceproduites.add(new TypePieceProduite("001", "Type pi�ce N� 1")) ;
    	typepieceproduites.add(new TypePieceProduite("002", "Type pi�ce N� 2")) ;
    	typepieceproduites.add(new TypePieceProduite("003", "Type pi�ce N� 3")) ;
    }
	*/
